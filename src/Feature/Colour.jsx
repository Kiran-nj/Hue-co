    ...
    return (
      <div className="">
        <motion.div animate={open ? "open" : "closed"} className="relative">
          ...
          >
            <Option  className="text-white" setOpen={setOpen}  text="RED" />
            <Option  className="text-white" setOpen={setOpen}  text="Blue" />
            <Option  className="text-white" setOpen={setOpen}  text="Black" />
            <Option  className="text-white" setOpen={setOpen}  text="White" />
          </motion.ul>
        </motion.div>
      </div>
    );
