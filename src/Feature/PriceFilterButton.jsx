    ...
    return (
      <div className="">
        <motion.div animate={open ? "open" : "closed"} className="relative">
          ...
          >
            <Option  className="text-white" setOpen={setOpen}  text="100 - 200>" />
            <Option  className="text-white" setOpen={setOpen}  text="200- 400>" />
            <Option  className="text-white" setOpen={setOpen}  text="> 400>" />
