    ...
    return (
      <div className="">
        <motion.div animate={open ? "open" : "closed"} className="relative">
          ...
          >
            <Option  className="text-white" setOpen={setOpen} Icon={PiTShirtBold} text="Tshirts" />
            <Option  className="text-white" setOpen={setOpen} Icon={PiTShirtBold} text="FullSleevs" />
            <Option  className="text-white" setOpen={setOpen} Icon={PiTShirtBold} text="Halfsleevs" />
            <Option  className="text-white" setOpen={setOpen} Icon={PiTShirtBold} text="Hoodies" />
          </motion.ul>
        </motion.div>
      </div>
    );
